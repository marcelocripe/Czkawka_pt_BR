...
rust_init_error_message =
	...
	Você pode tentar executar diferentes versões dos programas ‘skia_opengl’, ‘skia_vulkan e ‘femtovg_opengl’ (é o padrão) ou com um outro programa renderizador para verificar se estas ações resolvem o problema.
...
rust_hashed_images = Foram criados ‘{ $file_checked }’ de ‘{ $all_files }’ código do ‘hash’ dos arquivos de imagem
...
rust_cache_processed_files = Foram processados ‘{ $items }’ arquivos de ‘cache’
